...
\usepackage{gensymb}
\usepackage{datetime}
\usepackage[acronym,nopostdot,toc,nonumberlist,section,nomain]{glossaries}
\usepackage{setspace}
...
\newdateformat{specialdate}{\THEDAY.\twodigit{\THEMONTH}.\twodigit{\THEYEAR}}

%input file for the list of abbreviations
\input{abbr.tex}
...
\thesistitle{<Course Name>t}
\place{Espoo}
\date{\specialdate\today}
\supervisor{<Lecturer Name>l} 
\uselogo{aaltoGreen}{?}
...
\newpage
\glsaddall % un-comment \glsaddall to show all abbreviations
\begin{singlespacing}
 %\printglossary[type=\acronymtype, title=Abbreviations]
	\printacronyms[title=Abbreviations, style=super, nogroupskip=true]
\end{singlespacing}
